...
contract CTokenStorage {
    ...
    /**
     * @notice Maximum borrow rate that can ever be applied (.00005% / second)
     */
...
contract CTokenInterface is CTokenStorage {
    ...
    function _reduceReserves(address payable to, uint256 reduceAmount) external returns (uint256);
...
contract CWrappedNativeInterface is CErc20Storage {}
